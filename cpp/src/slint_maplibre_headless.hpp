...
// --- Renderer Observer ---
// Receives repaint requests from MapVina and forwards them to the Slint event
...
// --- Main MapVina Integration Class ---
class SlintMapVina : public mbgl::MapObserver {
public:
    SlintMapVina();
    ~SlintMapVina();
