...
This guide provides step-by-step instructions for building the canonical C++ reference application for `mapvina-native-slint` on macOS with Apple Silicon (M1/M2/M3/M4).
...
```bash
./build/Debug/mapvina-slint-example
```
